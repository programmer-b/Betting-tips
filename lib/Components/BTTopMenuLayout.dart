import 'package:bettingtips/Components/BTMenuButton.dart';
import 'package:bettingtips/Provider/BTProvider.dart';
            ...
            for (int i = 0; i < 6; i++)
              BTMenuButton(
                ...
                onTap: () => provider.updateScreen(context,
                    index: generateNavigationIndex(provider, i), pageRouteAnimation: null),
              ),
          ],
        ).paddingAll(16);
      },
